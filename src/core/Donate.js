        ...
        DonateDiv.map((mission, index) => {
          return (
            <div className="donate-mission">
              ...
              <ProgressBar max={1000} now={mission.progress} variant="warning" style={{margin: "20px auto"}} label={parseInt((mission.progress/1000)*100)+ "%"} />
...
export const DonateData = () => {
  const dataArray = [
    ...
    {
      number: <CountUp end={25} start={0} delay={0.5} duration={1} suffix="+" />,
      task: "cities"
    },
    {
  ...
  return (
    <div data-aos="fade-up" className="donate-comp">
      ...
      <div className="donate-buttons">
        <a href="https://www.payumoney.com/webfronts/#/index/da" rel="noopener noreferrer" target="_blank"><button className="donate">{'\u20B9'} 50</button></a>
        <a href="https://www.payumoney.com/webfronts/#/index/da" rel="noopener noreferrer" target="_blank"><button className="donate">{'\u20B9'} 100</button></a>
        <a href="https://www.payumoney.com/webfronts/#/index/da" rel="noopener noreferrer" target="_blank"><button className="donate">{'\u20B9'} 200</button></a>
        <a href="https://www.payumoney.com/webfronts/#/index/da" rel="noopener noreferrer" target="_blank"><button className="donate">{'\u20B9'} 500</button></a>
      </div>
    </div>
  );
}
