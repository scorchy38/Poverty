...
export const DonateButton = () => {
  return (
    <button className="donate-vertical">
      <a target="_blank" rel="noopener noreferrer" href="https://www.payumoney.com/webfronts/#/index/da">Donate</a>
    </button>
  )    
}
          ...
          <div className="footer">
            <div className="footer-content">
              <div className="footer-comp">
                <img src={Logo} alt="" />
                <h4>INITIATIVE BY:<br /> SINHAYANA FOUNDATION</h4>
              </div>
              <div className="footer-comp">
                <h4>About Us</h4>
                <p>Initiated in 2016, Dance Out of Poverty is
                the flagship program of Sinhayana Foundation,
                an independent, non-profit organisation. The
                program aims at uplifting children from underprivileged background and instill passion,
                creativity and life skills in them through dance.</p>
              </div>
              <div className="footer-comp">
                <h4>Social Media</h4>
                
                  <li><a href="jdfakkl"><i className='fa fa-facebook' ></i></a></li>
                  <li><a href="jdfakkl"><i className="fa fa-twitter" ></i></a></li>
                  <li><a href="jdfakkl"><i className='fa fa-linkedin' ></i></a></li>
                  <li><a href="jdfakkl"><i className='fa fa-youtube-play' ></i></a></li>
                  <li><a href="jdfakkl"><i className='fa fa-instagram'></i></a></li>
                
              </div>
              <div className="footer-comp">
                <h4>Quick Contact</h4>
                <p> A-178, First Floor, Gulabbagh<br />
                    Uttam Nagar<br />
                    PIN Code: 110059<br />
                    Email: info@danceoutofpoverty.org<br />
                    Phone: +91 9990766799
                </p>
              </div>
              <div className="footer-comp">
